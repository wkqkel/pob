  ...
  <section className={styles.about}>
    <div className={styles.content}>
      ...
      <section>
        ...
        <ul>
          <li>
            <h3>부산대학교 졸업 (2014.03 ~ 2022.02)</h3>
            <p>
              건축설계를 전공하면서 늘 아쉬웠던 점은, 빠르게 실패 경험이 쌓이지 않는 것이었습니다. 그에 반해 개발은
              만드는 과정에서도 컴퓨터가 에러를 일으키고, 배포 후에도 사용자 피드백을 바탕으로 개선을 해나갑니다. 특히
              프론트엔드는 사용자에게 직접적으로 노출되어 상호작용한다는 점이 상당히 매력적이었고, 이는 개발을 배우는
              과정에서도 큰 성취감으로 다가왔습니다.
            </p>
          </li>
          <li>
